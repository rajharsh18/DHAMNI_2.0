...
if(isset($_POST['reg_no'])){
    ...
    $email = $_POST['email'];
    $sql = "INSERT INTO `dhamni`.`blood_bank` (`reg_no`, `name`, `address`, `pincode`,`state`, `contact_number`, `email`) VALUES ('$reg_no', '$name', '$address', '$pincode','$state' , '$contact_number', '$email')";
