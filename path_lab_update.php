...
if(isset($_POST['reg_no'])){
    ...
    $email = $_POST['email'];
    $sql = "UPDATE `dhamni`.`path_lab` SET `Name` = '$name', `Address` = '$address', `Pincode` = '$pincode', `Contact_Number` = '$contact_number', `Email` = '$email', `state`='$state' WHERE `path_lab`.`Reg_no` = '$reg_no';";
    $insert = 0;
    // echo $sql;
...
<head>
    ...
    <title>Update Path-Lab Information</title>
